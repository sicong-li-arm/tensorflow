...
void TestSoftmaxInQuantized8SignedOutQuantized16Signed(
    std::initializer_list<int> input_dims_data,
    std::initializer_list<int8_t> input_data, float input_min, float input_max,
    std::initializer_list<int16_t> expected_output_data,
    std::initializer_list<int> output_dims_data, float output_min,
    float output_max, int16_t* output_data) {
  TfLiteIntArray* input_dims = IntArrayFromInitializer(input_dims_data);
  TfLiteIntArray* output_dims = IntArrayFromInitializer(output_dims_data);
  const int output_dims_count = ElementCount(*output_dims);
...
void TestSoftmaxInQuantized16SignedOutQuantized8Signed(
    std::initializer_list<int> input_dims_data,
    std::initializer_list<int16_t> input_data, float input_min, float input_max,
    std::initializer_list<int8_t> expected_output_data,
    std::initializer_list<int> output_dims_data, float output_min,
    float output_max, int8_t* output_data) {
  TfLiteIntArray* input_dims = IntArrayFromInitializer(input_dims_data);
...
void TestSoftmaxQuantized16Signed(
    std::initializer_list<int> input_dims_data,
    std::initializer_list<int16_t> input_data, float input_min, float input_max,
    std::initializer_list<int16_t> expected_output_data,
    std::initializer_list<int> output_dims_data, float output_min,
...
TF_LITE_MICRO_TEST(SimpleTestQuantized16Signed) {
  ...
  const std::vector<int16_t> quant_input =
      {
  ...
  std::cout << "quant_input: ";
  for (auto& quant_val : quant_input) {
      std::cout << quant_val << ", ";
  }
  std::cout << std::endl;
  tflite::testing::TestSoftmaxQuantized16Signed(  //
      {2, 1, 5},                                // Input shape.
      {
       F2Q16S(1.0, input_min, input_max), F2Q16S(2.0, input_min, input_max),
       F2Q16S(3.0, input_min, input_max), F2Q16S(4.0, input_min, input_max),
      ...
      {
          // Expected results.
          F2Q16S(0.011656231, output_min, output_max),
          F2Q16S(0.031684921, output_min, output_max),
          F2Q16S(0.086128544, output_min, output_max),
          F2Q16S(0.234121657, output_min, output_max),
...
TF_LITE_MICRO_TEST(SimpleTestInQuantized8SignedOutQuantized16Signed) {
  using tflite::testing::F2QS;
  using tflite::testing::F2Q16S;
  ...
  const int output_dims_count = 5;
  int16_t output_data[output_dims_count];
  tflite::testing::TestSoftmaxInQuantized8SignedOutQuantized16Signed(  //
      {2, 1, 5},                                // Input shape.
      {
       F2QS(1.0, input_min, input_max), F2QS(2.0, input_min, input_max),
       F2QS(3.0, input_min, input_max), F2QS(4.0, input_min, input_max),
...
TF_LITE_MICRO_TEST(SimpleTestInQuantized16SignedOutQuantized8Signed) {
  ...
  const int output_dims_count = 5;
  int8_t output_data[output_dims_count];
  tflite::testing::TestSoftmaxInQuantized16SignedOutQuantized8Signed(  //
      {2, 1, 5},                                // Input shape.
      {
       F2Q16S(1.0, input_min, input_max), F2Q16S(2.0, input_min, input_max),
       F2Q16S(3.0, input_min, input_max), F2Q16S(4.0, input_min, input_max),
...
/**   const float input_min = -16383.5f; */
/**   const float input_max = 16384.0f; */
/**   const float output_min = 0.0f; */
/**   const float output_max = (65535.0f / 65536.0f); */
/**   const int output_dims_count = 10; */
/**   int16_t output_data[output_dims_count]; */
/**   tflite::testing::TestSoftmaxQuantized16Signed(  // */
/**       {2, 2, 5},                                // Input shape. */
/**       {                                         // b = 0 */
/**        F2Q16S(-3.0, input_min, input_max), F2Q16S(5.0, input_min, input_max), */
/**        F2Q16S(-7.0, input_min, input_max), F2Q16S(9.0, input_min, input_max), */
/**        F2Q16S(-11.0, input_min, input_max), */
/**        // b = 1 */
/**        F2Q16S(1.0, input_min, input_max), F2Q16S(2.0, input_min, input_max), */
/**        F2Q16S(3.0, input_min, input_max), F2Q16S(4.0, input_min, input_max), */
/**        F2Q16S(5.0, input_min, input_max)}, */
...
/**           // Expected results. */
/**           // b = 0 */
/**           F2Q16S(0.000006933, output_min, output_max), */
/**           F2Q16S(0.017986099, output_min, output_max), */
/**           F2Q16S(0.000000110, output_min, output_max), */
/**           F2Q16S(0.982007754, output_min, output_max), */
/**           F2Q16S(0.000000002, output_min, output_max), */
/**           // b = 1 */
/**           F2Q16S(0.011656231, output_min, output_max), */
/**           F2Q16S(0.031684921, output_min, output_max), */
/**           F2Q16S(0.086128544, output_min, output_max), */
